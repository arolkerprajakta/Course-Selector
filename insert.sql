//data for courses picked from https://ntst.umd.edu/soc/
...
insert into student_account_details(title,first_name,middle_name,last_name,email,birth_date,password) values ("Miss","Prajakta","Sanjeev","Arolker","admin","20-AUG-1980","admin");
